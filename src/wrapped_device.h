...
public:
    ...
    HRESULT STDMETHODCALLTYPE ExecuteMetaCommand(ID3D12MetaCommand*, const void*, SIZE_T, const void*, SIZE_T) override;
    HRESULT STDMETHODCALLTYPE BuildRaytracingAccelerationStructure(ID3D12GraphicsCommandList4*, const D3D12_BUILD_RAYTRACING_ACCELERATION_STRUCTURE_DESC*, UINT, const D3D12_RAYTRACING_ACCELERATION_STRUCTURE_POSTBUILD_INFO_DESC*) override;
    HRESULT STDMETHODCALLTYPE EmitRaytracingAccelerationStructurePostbuildInfo(ID3D12GraphicsCommandList4*, const D3D12_RAYTRACING_ACCELERATION_STRUCTURE_POSTBUILD_INFO_DESC*, UINT, const D3D12_GPU_VIRTUAL_ADDRESS*) override;
    HRESULT STDMETHODCALLTYPE CopyRaytracingAccelerationStructure(ID3D12GraphicsCommandList4*, D3D12_GPU_VIRTUAL_ADDRESS, D3D12_GPU_VIRTUAL_ADDRESS, D3D12_RAYTRACING_ACCELERATION_STRUCTURE_COPY_MODE) override;
